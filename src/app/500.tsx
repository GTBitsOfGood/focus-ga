    ...
    return (
        <div className="bg-[url('/Portal_Background.avif')] bg-cover bg-no-repeat h-screen w-screen">
            ...
            <div className="mx-[24vw] flex flex-col justify-center items-center h-screen">
                <h1 className="text-8xl	font-lato text-center text-opacity-80 font-extrabold">500</h1>
                <p className="font-lato text-center text-3xl font-bold">Internal Server Error</p>
                <p className="font-lato text-2xl text-center mt-8 font-normal">Our fault! We are having a problem with our system. In the meantime, you can try refreshing the page.</p>
                <ErrorPageButtons />
            </div>
        </div>
    )
